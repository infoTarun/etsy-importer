...
export const loader = async ({request}) => {
    ...
    const productIds = url.searchParams.get("product_id")
      ?.split(",")
    ...
    for(const productId of productIds){
        ...
        console.log("import to shopify ",productId);
            ...
            if (product.option1name == "") {
                ...
                const queryProduct = `mutation CreateProduct($product: ProductCreateInput!,$media:[CreateMediaInput!]) {
    ...
    return json({ msg: "Product has been Import." }, { status: 202 });
};
